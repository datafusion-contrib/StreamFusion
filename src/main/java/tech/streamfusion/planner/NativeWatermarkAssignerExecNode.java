 ...
 * batches, forwarding each unchanged while emitting bounded out-of-orderness watermarks.
 */
public class NativeWatermarkAssignerExecNode extends ExecNodeBase<ArrowBatch>
