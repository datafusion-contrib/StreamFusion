 ...
 * batches, assigning each row to its window(s) and appending window_start/window_end/window_time.
 */
public class NativeWindowTableFunctionExecNode extends ExecNodeBase<ArrowBatch>
    implements StreamExecNode<ArrowBatch>, SingleTransformationTranslator<ArrowBatch> {

  private static final String TRANSFORMATION = "native-window-table-function";
