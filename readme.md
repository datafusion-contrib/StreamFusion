...
These are Apple M1 Max release+`mimalloc` results measured 2026-08-11 at parallelism 4, with one
warmup and the best of three measured runs. The memory columns compare Flink's default heap state
