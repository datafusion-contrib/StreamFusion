...
impl ProtobufEncodeOptions {
    pub fn parse(encoded: &str) -> Result<ProtobufEncodeOptions, String> {
    ...
    pub fn encoder(&self) -> ProtobufEncoder {
...
impl ProtobufEncoder {
    ...
    pub fn encode(&self, batch: &RecordBatch) -> EncodedMessages {
