...
// Shared by native text encoders and the JVM spelling probe.
#[allow(dead_code)]
pub fn jdk_double_to_string(value: f64, out: &mut Vec<u8>) {
...
#[allow(dead_code)]
pub fn jdk_float_to_string(value: f32, out: &mut Vec<u8>) {
