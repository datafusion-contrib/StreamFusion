...
pub fn parse_iso_local_date(s: &str) -> Option<i32> {
    let b = s.as_bytes();
...
/// as the host.
pub fn parse_java_sql_date(s: &str) -> Option<i32> {
...
pub fn parse_sql_time_second_of_day(s: &str) -> Option<i64> {
...
pub fn parse_jackson_base64(s: &str) -> Result<Vec<u8>, Base64Error> {
