...
pub type DecodeBodyBatch = extern "C" fn(
    decoder_handle: i64,
...
pub type DecodeLastError = extern "C" fn(decoder_handle: i64, len_out: *mut i32) -> *const u8;
...
pub struct FormatDriver {
    pub decode_body_batch: DecodeBodyBatch,
    /// Version 2 and above; untouched by a version-1 init.
    pub decode_last_error: DecodeLastError,
}
...
pub type FormatDriverInit = extern "C" fn(version: i32, driver: *mut FormatDriver) -> i32;

/// ABI revision 1: `decode_body_batch` only; a failed decode reports just its nonzero code.
pub const FORMAT_DRIVER_VERSION_1: i32 = 1;
...
pub const FORMAT_DRIVER_VERSION_2: i32 = 2;
