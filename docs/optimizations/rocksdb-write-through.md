...
rankers, the event-time window join, the aligned and session event-time window aggregates, and
event-time over aggregates today; each migrated operator inherits it)
