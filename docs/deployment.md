...
```sh
STREAMFUSION_VERSION=0.1.0-rc3
curl --fail --location \
...
`tech.streamfusion:streamfusion-kafka:0.1.0-rc3` and
`tech.streamfusion:streamfusion-json:0.1.0-rc3`. Install the matching stock Flink connector and
