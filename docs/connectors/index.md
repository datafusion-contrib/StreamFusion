...
supports) and [Delta Lake](delta.md) (path-based append and merge-on-read sinks) also have native
paths, but they have not seen the same production hardening as Kafka — treat them as experimental.
